...
describe('AddUserCase', () => {
  it('should orchestrating the add uer action correctly', async () => {
    // Arrange
    ...
    const getUserCase = new AddUserUseCase({
      userRepository: mockUserRepository,
      passwordHash: mockPasswordHash,
    });

    // Action
    const registeredUser = await getUserCase.execute(useCasePayload);
